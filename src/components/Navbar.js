...
export default (props) => {
  ...
  return (
    <Navbar expanded className="ps-0 pe-2 pb-0" style={{borderBottom: '1px solid lightgray'}}>
          ...
          <Nav className="align-items-center">
            ...
            <Dropdown as={Nav.Item}>
              <Dropdown.Toggle as={Nav.Link} className="pt-1 px-0">
                ...
                <span className="icon icon-sm">
                  <FontAwesomeIcon color="black" icon={faCog} className="bell-shake" />
                </span>
                
              </Dropdown.Toggle>
              <Dropdown.Menu className="user-dropdown dropdown-menu-right mt-2">
                <Dropdown.Item className="fw-bold">
                  <FontAwesomeIcon icon={faUserCircle} className="me-2" />{userData?.username}
                </Dropdown.Item>
                <Dropdown.Item className="fw-bold">
