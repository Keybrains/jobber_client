...
import ReactHero from "../assets/img/favicon(2).png";
...
export default (props = {}) => {
  ...
  const handleSignOut = () => {
    // Remove token from local storage or perform logout action here
    localStorage.removeItem("authToken"); // Remove the authentication token

    // Redirect to the sign-in page or perform any other actions after logout
  ...
  return (
    <>
      ...
      <CSSTransition timeout={300} in={show} classNames="sidebar-transition">
        <SimpleBar
          className={`collapse ${showClass} sidebar d-md-block bg-dark bg-gradient text-white`}
        >
          <div className="sidebar-inner px-4 pt-3">
            ...
            {userData && (
              <>
                {" "}
                <div className="d-flex align-items-center">
                  {/* Display user's first name dynamically */}
                  <div className="user-avatar lg-avatar me-1">
                    <FontAwesomeIcon
                      icon={faUser}
                      style={{ fontSize: "25px" }}
                    />
                  ...
                  <div className="d-block">
                    <h6>{`Hi, ${userData.id.first_name || ""} ${
                      userData.id.last_name || ""
                    }`}</h6>
                  </div>
                </div>
              </>
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              {/* <NavItemimage title="Job Cloud" image={ReactHero} /> */}
              ...
              <NavItem
                title="Requests"
                icon={faInbox}
                link={Routes.RequestDashboard.path}
              />

              <NavItem title="Quotes" icon={faQuoteLeft} link={"#"} />

              {/* <NavItem
                title="Clients"
                link={Routes.ClientDashBoard.path}
                icon={faAddressBook}
              /> */}
              ...
              <NavItem title="Appointment" link={"#"} icon={faCalendarCheck} />
              <NavItem title="Invoices" icon={faFileInvoiceDollar} link={"#"} />
              {/* <Dropdown.Divider className="my-3 " /> */}
              {/* <CollapsableNavItem eventKey="tables/" title="Tables" icon={faTablet}>
              ...
              <button
                ...
                className="text-white bg-transparent d-flex align-items-center"
              ...
              <Dropdown.Divider className="my-3 " />
              {/* <CollapsableNavItem eventKey="examples/" title="Page Examples" icon={faBook}>
